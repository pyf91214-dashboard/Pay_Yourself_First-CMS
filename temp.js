    ...
    "journey": {
        ...
        "btn2_link": "packages.html"
                  ...
                  contact_us: {
                    hero: {
                        headline: 'Contact Us',
                        desc: 'We are here to help and answer any questions you might have.',
                        image: 'Contact-Us/Hero.jpg'
                    },
                    info: {
                        email: 'support@payyourselffirst.com',
            ...
            async uploadImageTo(event, targetPath) {
                ...
                try {
                    ...
                    // Resolve dot-path and set value (e.g. 'pageData.home.tax_systems.image')
                    const parts = targetPath.split('.');
                    let obj = this;
                    for (let i = 0; i < parts.length - 1; i++) obj = obj[parts[i]];
                    obj[parts[parts.length - 1]] = data.publicUrl;
                    
                    // Force Alpine to recognize deep mutations on uninitialized keys
